      ...
      <div className="flex flex-col items-center text-center">
        <a href="#" className="flex items-center justify-center mb-4">
          <span className="text-2xl font-bold text-black dark:text-white">
            ИИ<span className="text-[#7A7FEE]">Марафон</span>
          </span>
        </a>
        <p className="text-sm text-gray-600 dark:text-gray-400 max-w-md mx-auto mb-8">
          Нейросети для бизнеса и личного бренда. Онлайн-марафон Ирины Петровой.
        </p>

        <p className="text-sm text-gray-500 dark:text-gray-400">
          {new Date().getFullYear()} ИИМарафон · Ирина Петрова. Все права защищены.
        </p>
      </div>
    </footer>
  )
